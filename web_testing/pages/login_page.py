...
class LoginPage:
    ...
    def __init__(self, driver):
        ...
        # Seletor robusto para mensagens de erro
        self.error_msg_container = (By.CSS_SELECTOR, "[data-test='error']")
    ...
    def obter_mensagem_erro(self):
        """Captura o texto de erro na tela"""
        return self.driver.find_element(*self.error_msg_container).text